...
export async function tagall(client, message) {
    ...
    try {
        ...
        await client.sendMessage(remoteJid, {
            text: `╭─⌈ 🚀 NARUTO-MD-V1 Broadcast ⌋\n│\n${text}\n│\n╰─⌊ Powered by Golden Naruto ⌉`,
...
export async function tagadmin(client, message) {
    ...
    try {
        ...
        const text = `╭─⌈ 🛡️ NARUTO-MD-V1 Alert ⌋\n│ Admin Alert\n│\n${admins.map(user => `@${user.split('@')[0]}`).join('\n')}\n│\n╰─⌊ Golden Naruto Control ⌉`
...
export async function tag(client, message) {
    ...
    try {
        ...
        const text = parts.slice(1).join(' ') || 'NARUTO-MD-V1 Alert'
